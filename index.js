...
function createMenuItem(nameVar, priceVar, categoryVar){
    const newObject = {name: nameVar, price: priceVar, category: categoryVar}
    return newObject;
}
...
console.log(createMenuItem("Beer", 4, "Drink"))
...
function addReview(array, nameArg, ratingArg, feedbackArg){
  array.push({name: nameArg, rating: ratingArg, feedback: feedbackArg})
  return array
}
